...
#define AI_TOOLS_DATE_TIME   "Mon Dec 31 08:55:47 2018"
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  dense_4_weights_array.data_start = weights + 22656;
  dense_4_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_4_bias_array.data = weights + 23680;
  dense_4_bias_array.data_start = weights + 23680;
